...
var LazySyntaxHighlighter = (0, import_react16.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-BP7B2CQK-PBDOOHUT.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react16.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-BP7B2CQK-PBDOOHUT.js"), import("./formatter-2WMMO6ZP-LTB2HDVI.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
//# sourceMappingURL=chunk-JY45R3AQ.js.map
